function Autocomplete(url, inputAreaElement) {
  this.input = inputAreaElement;
  this.url = url;
...
for(let key in mixins) {
  Autocomplete.prototype[key] = function() {
    return function() {
      mixins[key].call(Autocomplete.prototype, ...arguments);
    }
  }()
};

// Object.assign(Autocomplete.prototype, mixins);

document.addEventListener('DOMContentLoaded', function() {
  var target = document.querySelector('input');
  var form = new Autocomplete('/countries?matching=', target);
});
...
//   Autocomplete.prototype[key] = function() {
//     methods[key].call(Autocomplete, ...arguments)
//   }
// }
