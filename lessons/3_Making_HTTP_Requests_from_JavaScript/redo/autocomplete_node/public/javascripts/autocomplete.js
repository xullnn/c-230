var Autocomplete = {
  ...
  valueChanged: function() { // hard bound with `Autocomplete` as execution context
  ...
  init: function() {
    ...
    // 'this' is the 'Autocomplete' object itself
    // this.input is referencing the `input` area on the page, as parent node
